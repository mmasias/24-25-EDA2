...
public class RellenoInundacion {
    ...
    public static void main(String[] args) {
        ...
        rellenarRecursivo(imagen, 4, 4, 'º', '\0');
        rellenarRecursivo(imagen, 20, 4, 'º', '\0');
        rellenarRecursivo(imagen, 36, 4, 'º', '\0');

        rellenarRecursivo(imagen, 4, 10, 'x', '\0');
        rellenarRecursivo(imagen, 16, 10, 'x', '\0');
        rellenarRecursivo(imagen, 28, 10, 'x', '\0');
        rellenarRecursivo(imagen, 40, 10, 'x', '\0');

        rellenarRecursivo(imagen, 4, 15, '|', '\0');
        rellenarRecursivo(imagen, 20, 15, '|', '\0');
        rellenarRecursivo(imagen, 36, 15, '|', '\0');
