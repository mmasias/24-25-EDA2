...
public class RellenoInundacion {
    ...
    public static void main(String[] args) {
        ...
        do{
            System.out.println("Coordenadas del inicio del area: x: , y: , caracter a cambiar: , salir");
            int x = new Scanner(System.in).nextInt();
            int y = new Scanner(System.in).nextInt();
            char nuevoCaracter = new Scanner(System.in).next().charAt(0);
            salir = new Scanner(System.in).nextLine();

            rellenarRecursivo(imagen, x, y, nuevoCaracter, '\0');
            imprimirImagen(imagen);
        ...
        // imprimirImagen(imagen);
        // System.out.println("Imagen después del relleno por inundación habiendo
        // empezado en (0,0)");
