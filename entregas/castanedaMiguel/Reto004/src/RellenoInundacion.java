...
public class RellenoInundacion {
    ...
    public static void main(String[] args) {
        ...
        rellenarRecursivo(imagen, 0, 0, 'o', '\0');
        rellenarRecursivo(imagen, 5, 5, 'x', '\0');
        rellenarRecursivo(imagen, 20, 5, 'x', '\0');
        rellenarRecursivo(imagen, 35, 5, 'x', '\0');
        rellenarRecursivo(imagen, 5, 10, '/', '\0');
        rellenarRecursivo(imagen, 20, 10, '/', '\0');
        rellenarRecursivo(imagen, 30, 10, '/', '\0');
        rellenarRecursivo(imagen, 40, 10, '/', '\0');
        rellenarRecursivo(imagen, 5, 15, '%', '\0');
        rellenarRecursivo(imagen, 20, 15, '%', '\0');
        rellenarRecursivo(imagen, 35, 15, '%', '\0');
        imprimirImagen(imagen);
