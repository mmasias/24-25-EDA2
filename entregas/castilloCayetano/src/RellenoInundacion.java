...
public class RellenoInundacion {
    ...
    public static void main(String[] args) {
        ...
        pintarZonas(imagen);
        System.out.println("Imagen final con todas las zonas pintadas:");
        imprimirImagen(imagen);

        imagen = crearImagenEjemplo(PLANTILLA_001);
        int numeroHabitaciones = contarHabitaciones(imagen);
        System.out.println("Número de habitaciones encontradas: " + numeroHabitaciones);
    ...
    public static void pintarZonas(char[][] imagen) {
        char caracterActual = 'a';
        for (int y = 0; y < imagen.length; y++) {
            for (int x = 0; x < imagen[0].length; x++) {
                if (imagen[y][x] == '.') {
                    rellenarRecursivo(imagen, x, y, caracterActual, '.');
                    System.out.println("Imagen después de pintar la zona con '" + caracterActual + "':");
                    imprimirImagen(imagen);
                    caracterActual++;
                    if (caracterActual > 'z') {
                        caracterActual = 'A';
