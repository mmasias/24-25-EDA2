class Main {
  public static void main(String[] args) {
    ...
    System.out.println(picoMontana(new int[] { 1, 2, 3, 4, 5, 4, 2 }));

    System.out.println(elementoUnico(new int[] { 1, 2, 1, 3, 2, 3, 4 }));
  }
  ...
  public static int picoMontana(int[] numeros) {
    int izquierda = 0;
    int derecha = numeros.length - 1;
  ...
  public static int elementoUnico(int[] nums) {
    int uniqueElement = 0;
    for (int num : nums) {
      uniqueElement ^= num;
    }
