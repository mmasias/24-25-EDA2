...
public class PixelList {
    ...
    // Agrega un píxel al final de la lista
    ...
    // Retorna el píxel en la posición indicada (0-based)
    public Pixel get(int index) {
        ...
        return null; // Nunca debería ocurrir
    }

    // Establece el píxel en la posición indicada
