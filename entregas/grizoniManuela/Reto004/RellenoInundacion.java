...
public class RellenoInundacion {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Imagen original -- Pulse una tecla para empezar a pintar la imagen");
        new Scanner(System.in).nextLine();

        rellenarRecursivo(imagen, 0, 0, '\'', '\0');
        imprimirImagen(imagen);
        System.out.println("Fondo rellenado -- Pulse una tecla para continuar...");
        new Scanner(System.in).nextLine();

        rellenarRecursivo(imagen, 4, 3, 'o', '.');   
