public class PantallaEntrelazada {
    ...
    public PantallaEntrelazada(Resolucion resolucion) {
        ...
        listaFrames = new ListaCircularFrames(2,
                new Resolucion(resolucion.obtenerAncho() / 2, resolucion.obtenerAlto()));
    }
    ...
    public void establecerPixel(Coordenada coordenada, int color) {
        ...
        Coordenada coordenadaRelativa = new Coordenada(
                coordenada.obtenerX() - (resolucion.obtenerAncho() / 2) * dondeEsta, coordenada.obtenerY());
