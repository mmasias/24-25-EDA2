...
public class RellenoInundacion {
    ...
    public static void main(String[] args) {
        ...
        // Lo pinta de manera bella:
        int[][] coordenadas = {
                { 0, 0, '\'' }, { 3, 3, 'o' }, { 19, 3, 'o' }, { 35, 3, 'o' },
                { 3, 9, 'x' }, { 15, 9, 'x' }, { 27, 9, 'x' }, { 39, 9, 'x' },
                { 3, 14, '|' }, { 19, 14, '|' }, { 39, 14, '|' }
        };

        for (int[] c : coordenadas) {
            rellenarRecursivo(imagen, c[0], c[1], (char) c[2], '\0');
        }

        /*
         * Lo pinta de manera arcaica:
         ...
         * rellenarRecursivo(imagen, 39, 14, '|', '\0');
         */
