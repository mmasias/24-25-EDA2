...
public class FloodFill {
    ...
    public static void main(String[] args) {
        ...
        rellenarRecursivo(imagen, 4, 4, 'o', '.');
        rellenarRecursivo(imagen, 20, 4, 'o', '.');
        rellenarRecursivo(imagen, 36, 4, 'o', '.');

        rellenarRecursivo(imagen, 4, 10, 'x', '.');
        rellenarRecursivo(imagen, 16, 10, 'x', '.');
        rellenarRecursivo(imagen, 28, 10, 'x', '.');
        rellenarRecursivo(imagen, 40, 10, 'x', '.');
        
        rellenarRecursivo(imagen, 4, 15, '|', '.');
        rellenarRecursivo(imagen, 20, 15, '|', '.');
        rellenarRecursivo(imagen, 36, 15, '|', '.');
