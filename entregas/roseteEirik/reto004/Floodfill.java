...
public class Floodfill {
    ...
    public static void main(String[] args) {
        ...
        rellenarRecursivo(imagen, 3, 3, '+', '\0');
        rellenarRecursivo(imagen, 19, 3, '8', '\0');
        rellenarRecursivo(imagen, 35, 3, '*', '\0');
        rellenarRecursivo(imagen, 3, 9, 'o', '\0');
        rellenarRecursivo(imagen, 15, 9, '@', '\0');
        rellenarRecursivo(imagen, 27, 9, '~', '\0');
        rellenarRecursivo(imagen, 39, 9, '$', '\0');
